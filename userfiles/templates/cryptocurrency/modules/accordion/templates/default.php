    ...
    <?php foreach ($json as $key => $slide): ?>
        ...
        <div class="card">
            <div class="card-header" id="header-item-<?php print $edit_field_key ?>">
                <h5 class="mb-0">
                    <button class="btn btn-link" data-bs-toggle="collapse" data-target="#collapse-accordion-item-<?php print $edit_field_key . '-' . $key ?>" aria-expanded="true" aria-controls="collapse-accordion-item-<?php print $edit_field_key . '-' . $key ?>">
