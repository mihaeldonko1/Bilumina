...
<section class="section <?php print $layout_classes; ?> form-control-outline-dark edit safe-mode  " field="layout-contacts-skin-15-<?php print $params['id'] ?>" rel="module">
    <div class="container-fluid">
        <div class="row text-center text-lg-start">
            <div class="col-sm-12 col-md-6 col-lg-5 ps-md-5 element">
                <div class="ps-md-5 ms-md-5">
                    <div class="my-5">
