...
<section class="section <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-content-skin-24-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row d-flex justify-content-center justify-content-md-between">
            ...
            <div class="col-12 col-sm-10 col-md-6 col-lg-4 mb-4">
                <div class="allow-drop">
                    <h5>Dude You Re Getting A Telescope</h5>
