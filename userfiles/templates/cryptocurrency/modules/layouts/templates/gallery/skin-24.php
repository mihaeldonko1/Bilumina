...
<section class="section <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-gallery-skin-24-<?php print $params['id'] ?>" rel="module">
    <div class="container-fluid p-0">
        <div class="row text-center">
            <div class=" col-sm-10 col-md-6 mb-5 cloneable px-0">
