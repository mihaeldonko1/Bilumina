...
<section class="section <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-testimonials-skin-5-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        ...
        <module type="testimonials" template="skin-7" project_name="Testimonials 5"/>
    </div>
</section>
