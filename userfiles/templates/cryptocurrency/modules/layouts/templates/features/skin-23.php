...
<section class="section <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-feature-skin-23-<?php print $params['id'] ?>" rel="module" data-bg-contain="true" background-position="left center">
    <div class="container">
        <div class="row flex-lg-nowrap  mh-650">
            <div class="col-12 col-sm-10 col-lg-6 mx-auto pb-5 mb-4 pe-lg-8 text-center text-lg-start d-flex align-items-center order-2 order-lg-1">
